...
<div class="max-w-3xl mx-auto p-8 bg-white">
    ...
    <form action="/books/{{$book->id}}" method="POST">
        ...
        <label class="block mb-6">
            ...
            <input class="form-input mt-1 block w-64" placeholder="Grapes of Wrath" name="title" value="{{$book->title}}">
        </label>
        <div class="flex mb-6">
        ...
        <label class="block mb-6">
            ...
            <input type="hidden" role="uploadcare-uploader" data-image-shrink="1024x1024" name="photo" value="{{$book->photo}}" />
        </label>
        <label class="block mb-6">
            <span class="text-gray-700">Description</span>
            <textarea class="form-textarea mt-1 block w-full" rows="3" placeholder="Enter some long form content." name="description">{{$book->description}}</textarea>
        </label>
        <label class="block mb-6">
            <span class="text-gray-700">Price</span>
            <div class="flex items-center">
                <span class="text-gray-700 text-xl mr-2">$</span><input class="form-input mt-1 block w-32 " placeholder="11.00" name="cost" value="{{$book->cost}}">
            </div>
        </label>
